...
sys.path.insert(0, os.path.abspath('../rsbooster'))
import rsbooster as rsb

# -- Project information -----------------------------------------------------

project = 'rs-booster'
copyright = '2022, 1/Astronauts'
author = 'Jack B. Greisman, Kevin M. Dalton, Doeke R. Hekstra, Dennis E. Brookner, and others'

# The full version, including alpha/beta/rc tags
release = rsb.__version__
...
.. raw:: html
    ...
    <div class="admonition note">
      ...
      <a class="reference external" href="https://github.com/rs-station/rs-booster/blob/main/{{ docname|e }}">{{ docname|e }}</a>.
    #   Interactive online version:
    #   <span style="white-space: nowrap;">
...
def linkcode_resolve(domain, info):
    ...
    fn = os.path.relpath(fn, start=os.path.dirname(rsb.__file__))

    return f"https://github.com/rs-station/rs-booster/rsbooster/{fn}{linespec}"
